...
from iotweb_cctv.camerapub import Mycamera
from iotweb_cctv.camerapub_thread import camerapub
from threading import Event
import RPi.GPIO as gpio
import signal
from iotweb_cctv.distance import mydis
...
class mymqttworker:
    def __init__(self):
        ...
        #led, curtain
        self.led = LED()
        #self.curtain = Servo() #서보모터가 2개 필요
